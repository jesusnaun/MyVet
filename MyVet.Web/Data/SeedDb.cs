...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Jesus", "Agurto", "jesusnaun@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "Jesus", "Agurto", "jesusnaun@outlook.com", "350 634 2747", "Calle Luna Calle Sol", "Customer");
            ...
            string role)
        {
            ...
            if (user == null)
            {
                ...
                await _userHelper.AddUserAsync(user, "Jeshu1981");
